...
import 'package:hybridtravelagency/screens/sortandfilter/filter_screen.dart';
import 'package:hybridtravelagency/screens/sortandfilter/sort_by_screen.dart';
...
class SortAndFilterScreen extends StatelessWidget {
  SortAndFilterScreen({super.key});
  final SortAndFilterTabController sortAndFilterTabController =
      Get.put(SortAndFilterTabController());
  final SortAndFilterController filterController = Get.put(SortAndFilterController());
