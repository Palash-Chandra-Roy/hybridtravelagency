...
import 'package:hybridtravelagency/screens/home/HotelAndHomeStayScreens/HotelsScreen/coupon_code_screen.dart';
import 'package:hybridtravelagency/screens/home/HotelAndHomeStayScreens/HotelsScreen/select_gust_screen.dart';
import 'package:hybridtravelagency/screens/home/airport_cabs/cab_terminal/cab_terminal2_controller.dart';
...
class HotelReviewBookingScreen extends StatelessWidget {
  HotelReviewBookingScreen({super.key});
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        child: controller.selectedIndex == index
                                            ...
                                            colorFilter: ColorFilter.mode(greyD0D, BlendMode.srcIn)
                                        ),
                                      ),
                                      SizedBox(width: 8),
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        SvgPicture.asset(arrowDownIcon,
                                            colorFilter: ColorFilter.mode(black2E2, BlendMode.srcIn)),
                                      ],
                                    ),
                                  ),
                                ),
