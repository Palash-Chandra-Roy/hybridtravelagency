            ...
            children: [
              ListView.builder(
                ...
                itemBuilder: (context, index) => Padding(
                  ...
                  child: InkWell(
                    onTap: () {
                      if (Lists.flightSearchRoundTripList1[index]["text1"]
                              .toString()
                              .contains('DEPARTURE DATE') ||
                          Lists.flightSearchRoundTripList1[index]["text1"]
                              .toString()
                        ...
                        datePickerDialog(
                          ...
                          onConfirm: (date, _) {
                            ...
                            } else if (Lists.flightSearchRoundTripList1[index]
                                    ["text1"]
                                .toString()
                                .contains('RETURN DATE')) {
                        ...
                        child: Row(
                          children: [
                            SvgPicture.asset(Lists
                                .flightSearchRoundTripList1[index]["image"]),
                            SizedBox(width: 15),
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  CommonTextWidget.PoppinsMedium(
                                    text:
                                        Lists.flightSearchRoundTripList1[index]
                                            ["text1"],
                                    color: grey888,
                                    fontSize: 14,
                                  ),
                                  Row(
                                    children: [
                                      CommonTextWidget.PoppinsSemiBold(
                                        text:
                                            '${index == 0 ? controller.originAirportCountry : index == 1 ? controller.destinationAirportCountry : index == 2 ? controller.departureDate : controller.returnDate} ',
                                        color: black2E2,
                                        fontSize: 18,
                                      ),
                                      CommonTextWidget.PoppinsMedium(
