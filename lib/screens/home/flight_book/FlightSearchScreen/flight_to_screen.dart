                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          CommonTextWidget.PoppinsMedium(
                            text: controller.originController.text,
                            fontSize: 12,
                            color: black2E2,
                          ),
                          // RichText(
                      ...
                      ? Expanded(
                          child: ScrollConfiguration(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    var airport =
                                        controller.airportsList[index];
                                    return ListTile(
                                      onTap: () {
                                        controller.setDestination(airport);
