...
import 'package:hybridtravelagency/screens/sortandfilter/sort_and_filter_screen.dart';
import 'package:hybridtravelagency/screens/home/flight_book/FlightModifySearch/flight_modify_search.dart';
import 'package:hybridtravelagency/screens/home/flight_book/cheapest_list_screen.dart';
import 'package:hybridtravelagency/screens/home/flight_book/flight_book_controller.dart';
import 'package:hybridtravelagency/screens/home/flight_book/keep_track_price_screen.dart';
          ...
          children: [
            Column(
              children: [
                Container(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                        left: 18, right: 18, top: 60, bottom: 10),
                    child: Row(
                          ...
                          child: Container(
                            ...
                            child: ListTile(
                              ...
                              title: CommonTextWidget.PoppinsRegular(
                                text:
                                    "${controller.origin} to ${controller.destination}",
                                color: black2E2,
                                fontSize: 15,
                              ),
                              subtitle: CommonTextWidget.PoppinsRegular(
                                text:
                                    "${formatToDayMonth(controller.departureDate)} | ${controller.adults} Adult | ${controller.cabinClass}",
                                color: grey717,
                                fontSize: 12,
                              ),
                              trailing: InkWell(
                ...
                // ),
                SizedBox(height: 12),
                Expanded(child: CheapestListScreen()),
                // Expanded(
                //   child: TabBarView(
                //     controller: controller.tabController,
                //     children: [
