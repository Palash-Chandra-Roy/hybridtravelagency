...
class CheckInBaggageScreen extends StatelessWidget {
  CheckInBaggageScreen({super.key});
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: CommonTextWidget.PoppinsRegular(
                            text:
                                "Included Check-in baggage per person - ${SharedPrefUtil.flightOffer!.slices![0].segments![0].passengers![0].baggages![0]} KGS",
                            color: black2E2,
                            fontSize: 12,
                          ),
                        ),
                            ...
                            children: [
                              ListTile(
                                ...
                                title: CommonTextWidget.PoppinsMedium(
                                  text: Lists.checkInBaggageList[index]
                                      ["text1"],
                                  color: black2E2,
                                  fontSize: 12,
                                ),
                                ...
                                trailing: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border:
                                        Border.all(color: greyD9D, width: 1),
                                  ),
                                  child: Center(
