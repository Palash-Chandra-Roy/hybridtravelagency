...
import 'package:hybridtravelagency/screens/home/OutStationCabsScreen/out_station_cab_from_to_screen.dart';
          ...
          children: [
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    SvgPicture.asset(info, colorFilter: ColorFilter.mode(yellowCE8, BlendMode.srcIn)),
                    SizedBox(width: 10),
            ...
            InkWell(
              onTap: () {
                Get.to(() => SelectCheckInOutDateScreen(from: "Pick Up Time"));
              },
              child: Container(
                width: Get.width,
                decoration: BoxDecoration(
