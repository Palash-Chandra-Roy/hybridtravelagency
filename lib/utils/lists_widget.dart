...
import 'package:hybridtravelagency/screens/home/flight_book/FlightSearchScreen/flight_from_screen.dart';
import 'package:hybridtravelagency/screens/home/flight_book/FlightSearchScreen/flight_to_screen.dart';
import 'package:hybridtravelagency/screens/home/HolidayPackagesScreen/budget_screen.dart';
import 'package:hybridtravelagency/screens/home/HolidayPackagesScreen/duration_screen.dart';
import 'package:hybridtravelagency/screens/home/HolidayPackagesScreen/hotel_choice_screen.dart';
import 'package:hybridtravelagency/screens/home/HolidayPackagesScreen/suitable_screen.dart';
import 'package:hybridtravelagency/screens/home/HotelAndHomeStayScreens/HotelsScreen/hotel_and_homestay.dart';
import 'package:hybridtravelagency/screens/home/HotelAndHomeStayScreens/HotelsScreen/localitiy_screen.dart';
import 'package:hybridtravelagency/screens/home/HotelAndHomeStayScreens/HotelsScreen/popular_filter_screen.dart';
import 'package:hybridtravelagency/screens/home/HotelAndHomeStayScreens/HotelsScreen/price_range_screen.dart';
import 'package:hybridtravelagency/screens/home/HotelAndHomeStayScreens/HotelsScreen/property_type_screen.dart';
import 'package:hybridtravelagency/screens/home/HotelAndHomeStayScreens/rooms_and_guest_screen.dart';
import 'package:hybridtravelagency/screens/home/HotelAndHomeStayScreens/select_check_inout_date_screen.dart';
import 'package:hybridtravelagency/screens/home/TrainAndBusScreen/train_and_bus_from_screen.dart';
import 'package:hybridtravelagency/screens/home/TrainAndBusScreen/train_and_bus_to_screen.dart';
import 'package:hybridtravelagency/screens/home/VisaServicesScreen/apply_tourist_visa_screen.dart';
import 'package:hybridtravelagency/screens/notification/notification_screen.dart';
import 'package:hybridtravelagency/screens/SelectPaymentMethodScreen/mobile_wallet_screen.dart';
import 'package:hybridtravelagency/screens/SelectPaymentMethodScreen/net_banking_screen.dart';
import 'package:hybridtravelagency/screens/SelectPaymentMethodScreen/pay_by_card_screen.dart';
import 'package:hybridtravelagency/screens/SelectPaymentMethodScreen/pay_by_upi_screen.dart';
...
import 'package:hybridtravelagency/screens/Where2GoScreen/international_screen.dart';
...
class Lists {
  ...
  static List countryList = [
    {"image": argentina, "country": "Argentina", "code": "+54"},
    {"image": australia, "country": "Australia", "code": "+61"},
    {"image": belgique, "country": "Belgique", "code": "+32"},
    {"image": brazil, "country": "Brazil", "code": "+55"},
    {"image": canadaEnglish, "country": "Canada (English)", "code": "+1"},
    {"image": canadaEnglish, "country": "Canada (Francais)", "code": "+1"},
    {"image": chile, "country": "Chile", "code": "+56"},
    {"image": colombia, "country": "Colombia", "code": "+57"},
    {"image": cesko, "country": "Cesko", "code": "+420"},
    {"image": danmark, "country": "Danmark", "code": "+45"},
    {"image": deutschland, "country": "Deutschland", "code": "+49"},
    {"image": espana, "country": "Espana", "code": "+34"},
    {"image": france, "country": "France", "code": "+33"},
    {"image": india, "country": "India", "code": "+91"},
    {"image": ireland, "country": "Ireland", "code": "+353"},
    {"image": israel, "country": "Israel", "code": "+972"},
    {"image": italia, "country": "Italia", "code": "+39"},
    {"image": malaysia, "country": "Malaysia", "code": "+60"},
    {"image": maxico, "country": "Maxico", "code": "+52"},
    {"image": nederland, "country": "Nederland", "code": "+31"},
    {"image": newZealand, "country": "New Zealand", "code": "+64"},
    {"image": osterreich, "country": "Osterreich", "code": "+43"},
    {"image": peru, "country": "Peru", "code": "+51"},
    {"image": philippines, "country": "Philippines", "code": "+63"},
    {"image": polska, "country": "Polska", "code": "+48"},
    {"image": portugal, "country": "Portugal", "code": "+351"},
    {"image": schweiz, "country": "Schweiz (Deutsch)", "code": "+41"},
    {"image": singapore, "country": "Singapore", "code": "+65"},
    {"image": slovensko, "country": "Slovensko", "code": "+421"},
    {"image": suisse, "country": "Suisse (Francais)", "code": "+41"},
    {"image": suomi, "country": "Suomi", "code": "+358"},
    {"image": sverige, "country": "Sverige", "code": "+46"},
    {"image": suisse, "country": "Svizzera (italiano)", "code": "+41"},
    {"image": suisse, "country": "Switzerland (English)", "code": "+41"},
    {"image": thailand, "country": "Thailand (English)", "code": "+66"},
    {"image": turkiye, "country": "Turkiye", "code": "+90"},
    {
      "image": unitedArabEmirates,
      "country": "United Arab Emirates",
      "code": "+971"
    },
    {"image": uK, "country": "United Kingdom", "code": "+44"},
    {"image": uS, "country": "United States", "code": "+1"},
  ];
  ...
  static List<Map<String, dynamic>> sortList = [
    {
      "image": currencyInr,
      "text1": "Price",
      "attributes": ["None", "Cheapest First", "Highest First"],
    },
    {
      "image": timer,
      "text1": "Duration",
      "attributes": ["None", "Shortest First", "Longest First"],
    },
    {
      "image": departureTime,
      "text1": "Departure Time",
      "attributes": ["None", "Earliest First", "Latest First"],
    },
    {
      "image": arrivalTime,
      "text1": "Arrival Time",
  ...
  static List<Map> upTo5RoomsList = [
    {
      ...
      "text3": "",
      "onTap": () {
        RouteManagement.goToSearchCityScreen();
      },
    },
    {
      "image": calendarPlus,
      ...
      "text3": "’22, Wed",
      "onTap": () {
        Get.to(() => SelectCheckInOutDateScreen(
              from: 'Check-In-Date',
            ));
      },
    },
  ...
  static List<Map> travellersAndClassList = [
    {
      "text1": "Adults",
      "text2": "Age 13 years 7 above",
      "text3": "0",
  ...
  static List<Map> myAccountList = [
    {
      ...
      "text": "Flight",
      "onTap": () {
        RouteManagement.goToMyFlightScreen();
      },
    },

    {
      ...
      "text": "Hotel",
      "onTap": () {
        RouteManagement.goToMyHotelScreen();
      },
    },
    {
      "image": activityIcon,
      "text": "Activities",
      "onTap": () {
        RouteManagement.goToMyActivityScreen();
      },
    },
    {
      "image": tripPlanIcon,
    ...
    },
    {
      ...
      "text": "Visa",
      "onTap": () {
        RouteManagement.goToMyVisaScreen();
      },
    },
    {
      "image": suitcaseIcon,
      "text": "Holidays",
      "onTap": () {
        RouteManagement.goToMyHolidaysScreen();
      },
    },
    // {
    //   "image": suitcaseIcon,
  ...
  static Future<void> _handleLogout() async {
    try {
      ...
      final response = await repository.logout(isLoading: false);
