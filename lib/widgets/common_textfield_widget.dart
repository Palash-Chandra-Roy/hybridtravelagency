...
class CommonTextFieldWidget {
  ...
  static dynamic TextFormField6({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: grey9B9.withValues(alpha: 0.15),
        contentPadding: EdgeInsets.only(left: 12),
        disabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(5),
            borderSide: BorderSide(color: greyE2E, width: 1)),
  ...
  static dynamic TextFormField8({dynamic controller, keyboardType, hintText, suffixIcon}) {
    return TextFormField(
      keyboardType: keyboardType,
      cursorColor: black2E2,
      controller: controller,
  ...
  static dynamic TextFormField10({
    dynamic controller,
    keyboardType,
    hintText,
    onChange,
  ...
  static dynamic TextFormField11({
    dynamic prefixIcon,
    controller,
    keyboardType,
    hintText,
